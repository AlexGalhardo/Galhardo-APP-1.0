...
let p1 = document.querySelector("#welcome_api_phrase");

const writer = new Typewriter(p1, {
  loop: true
})

writer
  .type('Welcome to Galhardo APP!')
  .rest(800)
  .clear()
  .type('This project was created by Alex Galhardo github.com/alexgalhardo')
  .rest(800)
  .clear()
