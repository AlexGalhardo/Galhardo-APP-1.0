...
CREATE DATABASE `galhardoapp` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `galhardoapp`;
...
CREATE TABLE `games` (
  ...
  `price` int NOT NULL,
  `resume` varchar(1024) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `image` varchar(256) NOT NULL,
  `igdb_link` varchar(128) NOT NULL,
  `igdb_rating` float NOT NULL,
  `platforms` varchar(64) NOT NULL,
  `developer` varchar(64) NOT NULL,
  `genres` varchar(256) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
